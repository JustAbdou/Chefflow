...
export default function ClosingChecklistManageTasksScreen({ navigation }) {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      console.error("Closing manage add error:", e);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await deleteDoc(getRestaurantDoc(restaurantId, "closinglist", id));
    } catch (e) {
      console.error("Closing manage delete error:", e);
    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          <Text style={styles.title}>Manage closing tasks</Text>
          <Text style={styles.sub}>Closing checklist tasks</Text>
        </View>
      </View>
      <TouchableOpacity
        style={styles.addBtn}
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={{ paddingBottom: 48 }}>
        {loading ? (
          ...
          <Text style={styles.emptyText}>No closing tasks yet.</Text>
        ) : (
          tasks.map((task) => (
      ...
      >
        ...
        >
          ...
          <View style={styles.modalSheet}>
            <Text style={styles.modalTitle}>Add closing task</Text>
            <TextInput
